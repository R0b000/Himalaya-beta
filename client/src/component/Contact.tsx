...
const Contact = () => {
    return (
        <>
            {/* CONTACT */}
            <div id="contact" className="flex flex-col w-full items-center justify-center gap-2">
                <div className='flex flex-col w-full gap-2 items-center justify-center'>
                    <h2 className="text-2xl font-semibold">CONTACT</h2>
                    <div className="flex flex-col md:flex-row w-full lg:w-[50vw] md:w-[70vw] justify-evenly text-base items-center">
                ...
                <div className="flex flex-col items-center justify-center text-white w-full h-[350px] md:h-[500px] lg:h-[600px] gap-2">
